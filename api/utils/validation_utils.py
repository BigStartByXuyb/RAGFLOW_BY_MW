...
class CreateDatasetReq(Base):
    ...
    def validate_parser_dependency(self) -> "CreateDatasetReq":
        ...
        - If parser_id is omitted (field not set) → default chunk_method = "naive"
        - If parser_id is provided (valid enum) → parse_type must be one of [None, 1]
        ...
        # parser_id provided (valid): parse_type MUST be one of [None, 1]
