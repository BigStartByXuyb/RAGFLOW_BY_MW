...
import (
	...
	_ "ragflow/go/agent/component" // blank import: registers agent factories
	"ragflow/go/agent/runtime"
	_ "ragflow/go/ingestion/component"         // blank import: registers ingestion factories
	_ "ragflow/go/ingestion/component/chunker" // blank import: registers 4 chunker variants
)
