...
import (
	...
	_ "ragflow/go/agent/component" // registers agent components
	"ragflow/go/agent/runtime"
	"ragflow/go/handler"
	_ "ragflow/go/ingestion/component"         // registers ingestion main components
	_ "ragflow/go/ingestion/component/chunker" // registers 4 chunker variants
	"ragflow/go/service"
)
