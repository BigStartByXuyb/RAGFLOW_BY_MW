...
import (
	...
	"os/signal"
	"ragflow/go/admin"
	"ragflow/go/agent/audio"
	"ragflow/go/agent/canvas"
	agenttool "ragflow/go/agent/tool"
	"ragflow/go/channels"
	"ragflow/go/handler"
	ingestion "ragflow/go/ingestion/service"
	"ragflow/go/mcp"
	"ragflow/go/router"
	"ragflow/go/server/local"
	"ragflow/go/service"
	"ragflow/go/service/chunk"
	dataset "ragflow/go/service/dataset"
	"ragflow/go/service/document"
	"ragflow/go/service/file"
	"ragflow/go/service/nlp"
	"ragflow/go/storage"
	"ragflow/go/syncer"
	...
	"ragflow/go/dao"
	"ragflow/go/engine"
	"ragflow/go/engine/redis"
	_ "ragflow/go/ingestion/wire"
	"ragflow/go/server"
	"ragflow/go/utility"
)
